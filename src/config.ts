...
export const siteConfig: SiteConfig = {
	title: "WangKaiCode",
	subtitle: "TechBlog",
	siteURL: "https://tech-blog-six-sigma.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	font: {
		...
		asciiFont: {
			...
			fontFamily: "Consolas",
			fontWeight: "500",
			localFonts: ["Consolas.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
		cjkFont: {
			// 中日韩字体 - 作为回退字体
			fontFamily: "思源宋体 Light字体",
			fontWeight: "500",
			localFonts: ["思源宋体 Light字体.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/WangKaiCode/TechBlog",
					external: true,
